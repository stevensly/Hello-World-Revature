...
**Garbage collection**: The JVM performs automatic memory deallocation of unusued objects at runtime. Programs are written without the need forl complex memory management.

**Multithreading**: Java supports multithreading at both the language and the standard library levels. It allows concurrent and parallel execution of several parts of a Java program.
...
*Polymorphism* - With inheritence, an object of a derived class can be referenced as instances of its parent class.  This provides flexibility when invoking inherited methods with varying implementations in derived classes.
